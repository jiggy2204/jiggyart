            ...
            <div id="commissionpage" className="commission-page jiggypage active">
                <header className="pageHeader">
                    ...
                    <p className="header-text">
                        Want something original? Or maybe you want a different take on your favorite character? Take a look at the info and feel free to contact me if you have any questions!
                    </p>
                </header>
                <div className="commInfo-parent">
                    <section className="commissionInfo-holder" id="commissionInfo">
                        <div className="sketch-info comInfoMain">
                            <img src="./images/cP_Sketch.JPG" className="sketchex comPic"></img>
                        ...
                        <div className="lineart-info comInfoMain">
                            <img src="./images/cP_Lineart.JPG" className="lineex comPic"></img>
                        ...
                        <img src="./images/cP_ColorFlats.JPG" className="colorex comPic"></img>
                        ...
                        <img src="./images/carniverousPlant_lowRes.jpg" className="bgex comPic"></img>
                    ...
                    <section className="commNotification" id="commNotes">
                        <div className="customNotice">
                            <p className="customText">If you want a commission in another size other than listed, please contact me about pricing</p>
                        </div>
